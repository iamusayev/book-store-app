...
public class ExceptionConstants {
    ...
    public static final String SQL_VALIDATION_CODE = "SQL_VALIDATION_EXCEPTION";
    public static final String SQL_VALIDATION_MESSAGE = "You violated the uniqueness of some value";
}
